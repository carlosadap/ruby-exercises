...
def find_longest_word(word_list)
  ...
  word_list.reduce { |longest_word, next_word| longest_word.length > next_word.length ? 
...
def find_longer_words(word_list, base_word)
  ...
  word_list.reduce([]) { |accu_arr, word| (word.length > base_word.length) ? accu_arr.push(word) : accu_arr}
end
